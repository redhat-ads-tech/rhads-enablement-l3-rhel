...
[source,bash,role="execute"]
----
curl -s -H "Authorization:$(oidc-cli token trusty -b)" \
  https://rhtpa.${BASE_HOSTNAME}/api/v2/importer | jq
----
+
...
[
  {
    "name": "cve",//<1>
    "heartbeat": 1761060494629838144,//<2>
    "configuration": {//<3>
      "cve": {
        "disabled": false,
        "period": "1day",
...
<2> The last time the importer was updated.
<3> The configuration of the importer.
<4> The current state of the importer.
<5> The progress of the importer.
