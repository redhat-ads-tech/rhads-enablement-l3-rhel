...
// TODO verify "A Kubernetes-based manifest creates Kubernetes manifests" sicne it sounds odd
...
. Push the image to a registry (the epehemeral https://ttl.sh[ttl.sh^] registry):
+
[source,bash,role="execute"]
----
